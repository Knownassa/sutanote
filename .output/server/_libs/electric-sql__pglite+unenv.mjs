...
function We$2(e, t, n) {
	...
	if (!e.length) return "{}";
	let s = e[0], i = n === 1020 ? ";" : ",";
	return Array.isArray(s) ? `{${e.map((a) => We$2(a, t, n)).join(i)}}` : `{${e.map((a) => (a === void 0 && (a = null), a === null ? "null" : "\"" + fn(t ? t(a) : a.toString()) + "\"")).join(i)}}`;
}
var me$1 = {
	i: 0,
	char: null,
...
var Te$1 = {};
F$2(Te$1, {
	AuthenticationCleartextPassword: () => F$1,
	AuthenticationMD5Password: () => G$2,
	AuthenticationOk: () => V,
	AuthenticationSASL: () => Q,
	AuthenticationSASLContinue: () => _$1,
	AuthenticationSASLFinal: () => v$3,
	...
	ParameterDescriptionMessage: () => j$1,
	ParameterStatusMessage: () => W$3,
	ReadyForQueryMessage: () => $$2,
	...
	noData: () => xe$2,
	parseComplete: () => Be$2,
	portalSuspended: () => Me$2,
	replicationStart: () => Re$2
});
u$1();
var Be$2 = {
	name: "parseComplete",
...
var T$1 = class {
	constructor(t = 256) {
		...
		R$1(this, O$1, 0);
		x$3(this, b$2, T$2(this, S$2, ie$2).call(this, t));
	}
	addInt32(t) {
		return T$2(this, S$2, L$2).call(this, 4), h$1(this, b$2).setInt32(h$1(this, g$1), t, h$1(this, k$1)), x$3(this, g$1, h$1(this, g$1) + 4), this;
	}
	addInt16(t) {
		return T$2(this, S$2, L$2).call(this, 2), h$1(this, b$2).setInt16(h$1(this, g$1), t, h$1(this, k$1)), x$3(this, g$1, h$1(this, g$1) + 2), this;
	}
	addCString(t) {
		return t && this.addString(t), T$2(this, S$2, L$2).call(this, 1), h$1(this, b$2).setUint8(h$1(this, g$1), 0), U$1(this, g$1)._++, this;
	}
	addString(t = "") {
		let n = P$2(t);
		return T$2(this, S$2, L$2).call(this, n), h$1(this, ae$1).encodeInto(t, new Uint8Array(h$1(this, b$2).buffer, h$1(this, g$1))), x$3(this, g$1, h$1(this, g$1) + n), this;
	}
	add(t) {
		return T$2(this, S$2, L$2).call(this, t.byteLength), new Uint8Array(h$1(this, b$2).buffer).set(new Uint8Array(t), h$1(this, g$1)), x$3(this, g$1, h$1(this, g$1) + t.byteLength), this;
	}
	flush(t) {
		let n = T$2(this, S$2, Je$1).call(this, t);
		return x$3(this, g$1, 5), x$3(this, b$2, T$2(this, S$2, ie$2).call(this, this.size)), new Uint8Array(n);
	}
};
b$2 = /* @__PURE__ */ new WeakMap(), g$1 = /* @__PURE__ */ new WeakMap(), k$1 = /* @__PURE__ */ new WeakMap(), ae$1 = /* @__PURE__ */ new WeakMap(), O$1 = /* @__PURE__ */ new WeakMap(), S$2 = /* @__PURE__ */ new WeakSet(), ie$2 = function(t) {
	return new DataView(new ArrayBuffer(t));
}, L$2 = function(t) {
	if (h$1(this, b$2).byteLength - h$1(this, g$1) < t) {
		let s = h$1(this, b$2).buffer, i = s.byteLength + (s.byteLength >> 1) + t;
		x$3(this, b$2, T$2(this, S$2, ie$2).call(this, i)), new Uint8Array(h$1(this, b$2).buffer).set(new Uint8Array(s));
	}
}, Je$1 = function(t) {
	if (t) {
		h$1(this, b$2).setUint8(h$1(this, O$1), t);
		let n = h$1(this, g$1) - (h$1(this, O$1) + 1);
		h$1(this, b$2).setInt32(h$1(this, O$1) + 1, n, h$1(this, k$1));
	}
	return h$1(this, b$2).buffer.slice(t ? 0 : 5, h$1(this, g$1));
};
var f$2 = new T$1();
var wn = (e) => {
	f$2.addInt16(3).addInt16(0);
	for (let s of Object.keys(e)) f$2.addCString(s).addCString(e[s]);
	f$2.addCString("client_encoding").addCString("UTF8");
	let t = f$2.addCString("").flush(), n = t.byteLength + 4;
	return new T$1().addInt32(n).add(t).flush();
};
var An = () => {
...
var Sn = (e) => f$2.addCString(e).flush(112);
var Bn = (e, t) => (f$2.addCString(e).addInt32(P$2(t)).addString(t), f$2.flush(112));
var Dn = (e) => f$2.addString(e).flush(112);
var In = (e) => f$2.addCString(e).flush(81);
var xn = [];
var Mn = (e) => {
	let t = e.name ?? "";
	...
	let n = f$2.addCString(t).addCString(e.text).addInt16(e.types?.length ?? 0);
	return e.types?.forEach((s) => n.addInt32(s)), f$2.flush(80);
};
var U = new T$1();
var Rn = (e, t) => {
	for (let n = 0; n < e.length; n++) {
		let s = t ? t(e[n], n) : e[n];
		if (s === null) f$2.addInt16(0), U.addInt32(-1);
			...
			f$2.addInt16(1), U.addInt32(i.byteLength), U.add(i);
		} else f$2.addInt16(0), U.addInt32(P$2(s)), U.addString(s);
	}
};
var En = (e = {}) => {
	let t = e.portal ?? "", n = e.statement ?? "", s = e.binary ?? !1, i = e.values ?? xn, a = i.length;
	return f$2.addCString(t).addCString(n), f$2.addInt16(a), Rn(i, e.valueMapper), f$2.addInt16(a), f$2.add(U.flush()), f$2.addInt16(s ? 1 : 0), f$2.flush(66);
};
...
var Tn = (e) => {
	...
	let t = e.portal ?? "", n = e.rows ?? 0, s = P$2(t), i = 4 + s + 1 + 4, a = new DataView(new ArrayBuffer(1 + i));
...
var Pn = f$2.addCString("P").flush(68);
var Ln = f$2.addCString("S").flush(68);
var kn = (e) => e.name ? Ne$1(68, `${e.type}${e.name ?? ""}`) : e.type === "P" ? Pn : Ln;
var On = (e) => {
	return Ne$1(67, `${e.type}${e.name ?? ""}`);
};
var Un = (e) => f$2.add(e).flush(100);
var Vn = (e) => Ne$1(102, e);
...
var ue$2 = class {
	constructor(t = 0) {
		...
		R$1(this, w$2);
		R$1(this, ce$2, "utf-8");
		R$1(this, le$1, new TextDecoder(h$1(this, ce$2)));
		R$1(this, te, !1);
		x$3(this, w$2, t);
	}
	setBuffer(t, n) {
		x$3(this, w$2, t), x$3(this, R, new DataView(n));
	}
	int16() {
		let t = h$1(this, R).getInt16(h$1(this, w$2), h$1(this, te));
		return x$3(this, w$2, h$1(this, w$2) + 2), t;
	}
	byte() {
		let t = h$1(this, R).getUint8(h$1(this, w$2));
		return U$1(this, w$2)._++, t;
	}
	int32() {
		let t = h$1(this, R).getInt32(h$1(this, w$2), h$1(this, te));
		return x$3(this, w$2, h$1(this, w$2) + 4), t;
	}
	string(t) {
		return h$1(this, le$1).decode(this.bytes(t));
	}
	cstring() {
		let t = h$1(this, w$2), n = t;
		for (; h$1(this, R).getUint8(n++) !== 0;);
		let s = this.string(n - t - 1);
		return x$3(this, w$2, n), s;
	}
	bytes(t) {
		let n = h$1(this, R).buffer.slice(h$1(this, w$2), h$1(this, w$2) + t);
		return x$3(this, w$2, h$1(this, w$2) + t), new Uint8Array(n);
	}
};
R = /* @__PURE__ */ new WeakMap(), w$2 = /* @__PURE__ */ new WeakMap(), ce$2 = /* @__PURE__ */ new WeakMap(), le$1 = /* @__PURE__ */ new WeakMap(), te = /* @__PURE__ */ new WeakMap();
var Le$1 = 1;
var Xe$1 = Le$1 + 4;
...
var pe$1 = class {
	constructor() {
		...
		R$1(this, B$2, 0);
		R$1(this, D$3, 0);
		R$1(this, o$3, new ue$2());
	}
	parse(t, n) {
		T$2(this, c$1, et$1).call(this, ArrayBuffer.isView(t) ? t.buffer.slice(t.byteOffset, t.byteOffset + t.byteLength) : t);
		let s = h$1(this, D$3) + h$1(this, B$2), i = h$1(this, D$3);
		for (; i + Xe$1 <= s;) {
			let a = h$1(this, A).getUint8(i), u = h$1(this, A).getUint32(i + Le$1, !1), m = Le$1 + u;
			if (m + i <= s && u > 0) {
				let l;
				try {
					l = T$2(this, c$1, tt$1).call(this, i + Xe$1, a, u, h$1(this, A).buffer);
				} catch (E) {
					throw T$2(this, c$1, ke$2).call(this), E;
				}
				n(l), i += m;
			} else break;
		}
		i === s ? T$2(this, c$1, ke$2).call(this) : (x$3(this, B$2, s - i), x$3(this, D$3, i));
	}
};
A = /* @__PURE__ */ new WeakMap(), B$2 = /* @__PURE__ */ new WeakMap(), D$3 = /* @__PURE__ */ new WeakMap(), o$3 = /* @__PURE__ */ new WeakMap(), c$1 = /* @__PURE__ */ new WeakSet(), ke$2 = function() {
	x$3(this, A, new DataView(Ze$1)), x$3(this, B$2, 0), x$3(this, D$3, 0);
}, et$1 = function(t) {
	if (h$1(this, B$2) > 0) {
		let n = h$1(this, B$2) + t.byteLength;
		if (n + h$1(this, D$3) > h$1(this, A).byteLength) {
			let i;
			if (n <= h$1(this, A).byteLength && h$1(this, D$3) >= h$1(this, B$2)) i = h$1(this, A).buffer;
			else {
				let a = h$1(this, A).byteLength * 2;
				for (; n >= a;) a *= 2;
				i = new ArrayBuffer(a);
			}
			new Uint8Array(i).set(new Uint8Array(h$1(this, A).buffer, h$1(this, D$3), h$1(this, B$2))), x$3(this, A, new DataView(i)), x$3(this, D$3, 0);
		}
		new Uint8Array(h$1(this, A).buffer).set(new Uint8Array(t), h$1(this, D$3) + h$1(this, B$2)), x$3(this, B$2, n);
	} else x$3(this, A, new DataView(t)), x$3(this, D$3, 0), x$3(this, B$2, t.byteLength);
}, tt$1 = function(t, n, s, i) {
	switch (n) {
		case 50: return De$1;
		case 49: return Be$2;
		case 51: return Ie$2;
		case 110: return xe$2;
		case 115: return Me$2;
		case 99: return Ce$2;
		case 87: return Re$2;
		case 73: return Ee$1;
		case 68: return T$2(this, c$1, pt).call(this, t, s, i);
		case 67: return T$2(this, c$1, rt$1).call(this, t, s, i);
		case 90: return T$2(this, c$1, nt).call(this, t, s, i);
		case 65: return T$2(this, c$1, ot$1).call(this, t, s, i);
		case 82: return T$2(this, c$1, mt).call(this, t, s, i);
		case 83: return T$2(this, c$1, dt).call(this, t, s, i);
		case 75: return T$2(this, c$1, ft$1).call(this, t, s, i);
		case 69: return T$2(this, c$1, Ue$2).call(this, t, s, i, "error");
		case 78: return T$2(this, c$1, Ue$2).call(this, t, s, i, "notice");
		case 84: return T$2(this, c$1, ut).call(this, t, s, i);
		case 116: return T$2(this, c$1, lt).call(this, t, s, i);
		case 71: return T$2(this, c$1, it).call(this, t, s, i);
		case 72: return T$2(this, c$1, at$2).call(this, t, s, i);
		case 100: return T$2(this, c$1, st$1).call(this, t, s, i);
		default: return new N$1("received invalid response: " + n.toString(16), s, "error");
	}
}, nt = function(t, n, s) {
	h$1(this, o$3).setBuffer(t, s);
	return new $$2(n, h$1(this, o$3).string(1));
}, rt$1 = function(t, n, s) {
	h$1(this, o$3).setBuffer(t, s);
	return new X(n, h$1(this, o$3).cstring());
}, st$1 = function(t, n, s) {
	let i = s.slice(t, t + (n - 4));
	return new H$2(n, new Uint8Array(i));
}, it = function(t, n, s) {
	return T$2(this, c$1, Oe).call(this, t, n, s, "copyInResponse");
}, at$2 = function(t, n, s) {
	return T$2(this, c$1, Oe).call(this, t, n, s, "copyOutResponse");
}, Oe = function(t, n, s, i) {
	h$1(this, o$3).setBuffer(t, s);
	let a = h$1(this, o$3).byte() !== 0, u = h$1(this, o$3).int16(), m = new z$2(n, i, a, u);
	for (let l = 0; l < u; l++) m.columnTypes[l] = h$1(this, o$3).int16();
	return m;
}, ot$1 = function(t, n, s) {
	h$1(this, o$3).setBuffer(t, s);
	return new J$1(n, h$1(this, o$3).int32(), h$1(this, o$3).cstring(), h$1(this, o$3).cstring());
}, ut = function(t, n, s) {
	h$1(this, o$3).setBuffer(t, s);
	let i = h$1(this, o$3).int16(), a = new Y$1(n, i);
	for (let u = 0; u < i; u++) a.fields[u] = T$2(this, c$1, ct).call(this);
	return a;
}, ct = function() {
	return new q(h$1(this, o$3).cstring(), h$1(this, o$3).int32(), h$1(this, o$3).int16(), h$1(this, o$3).int32(), h$1(this, o$3).int16(), h$1(this, o$3).int32(), h$1(this, o$3).int16() === 0 ? Pe$1.text : Pe$1.binary);
}, lt = function(t, n, s) {
	h$1(this, o$3).setBuffer(t, s);
	let i = h$1(this, o$3).int16(), a = new j$1(n, i);
	for (let u = 0; u < i; u++) a.dataTypeIDs[u] = h$1(this, o$3).int32();
	return a;
}, pt = function(t, n, s) {
	h$1(this, o$3).setBuffer(t, s);
	let i = h$1(this, o$3).int16(), a = new Array(i);
	for (let u = 0; u < i; u++) {
		let m = h$1(this, o$3).int32();
		a[u] = m === -1 ? null : h$1(this, o$3).string(m);
	}
	return new Z(n, a);
}, dt = function(t, n, s) {
	h$1(this, o$3).setBuffer(t, s);
	return new W$3(n, h$1(this, o$3).cstring(), h$1(this, o$3).cstring());
}, ft$1 = function(t, n, s) {
	h$1(this, o$3).setBuffer(t, s);
	return new K(n, h$1(this, o$3).int32(), h$1(this, o$3).int32());
}, mt = function(t, n, s) {
	h$1(this, o$3).setBuffer(t, s);
	let i = h$1(this, o$3).int32();
	switch (i) {
		case 0: return new V(n);
		case 3: return new F$1(n);
		case 5: return new G$2(n, h$1(this, o$3).bytes(4));
		case 10: {
			let a = [];
			for (;;) {
				let u = h$1(this, o$3).cstring();
				if (u.length === 0) return new Q(n, a);
				a.push(u);
			}
		}
		case 11: return new _$1(n, h$1(this, o$3).string(n - 8));
		case 12: return new v$3(n, h$1(this, o$3).string(n - 8));
		default: throw new Error("Unknown authenticationOk message type " + i);
	}
}, Ue$2 = function(t, n, s, i) {
	h$1(this, o$3).setBuffer(t, s);
	let a = {}, u = h$1(this, o$3).string(1);
	for (; u !== "\0";) a[u] = h$1(this, o$3).cstring(), u = h$1(this, o$3).string(1);
...
function y$3(t, ...r) {
	...
	for (let p = 0; p < r.length; p++) {
		let n = r[p], i = p + 1;
		if (n?._templateType === o$2.part) {
			s$2(e, t[i], n.str), s$2(e.raw, t.raw[i], n.str);
			continue;
		}
		if (n?._templateType === o$2.container) {
			s$2(e, t[i], ...n.strings), s$2(e.raw, t.raw[i], ...n.strings.raw), a.push(...n.values);
			continue;
		}
...
function g(t, ...r) {
	let { strings: e, values: a } = y$3(t, ...r);
	return {
...
var z$1 = class {
	...
	async _initArrayTypes({ force: s = !1 } = {}) {
      ...
      ORDER BY b.oid
    `);
		for (let r of e.rows) this.serializers[r.typarray] = (o) => We$2(o, this.serializers[r.oid], r.typarray), this.parsers[r.typarray] = (o) => mn(o, this.parsers[r.oid], r.typarray);
	}
	async refreshArrayTypes() {
		await this._initArrayTypes({ force: !0 });
	}
	async query(s, e, r) {
		return await this._checkReady(), await this._runExclusiveTransaction(async () => await T$2(this, t, x$2).call(this, s, e, r));
	}
	async sql(s, ...e) {
	...
	async exec(s, e) {
		return await this._checkReady(), await this._runExclusiveTransaction(async () => await T$2(this, t, m$3).call(this, s, e));
	}
	async describeQuery(s, e) {
		let r = [];
		try {
			await T$2(this, t, y$2).call(this, $e$1.parse({
				text: s,
				types: e?.paramTypes
			}), e), r = await T$2(this, t, y$2).call(this, $e$1.describe({ type: "S" }), e);
		} catch (n) {
			...
			r.push(...await T$2(this, t, y$2).call(this, $e$1.sync(), e));
		}
	...
	async transaction(s) {
		return await this._checkReady(), await this._runExclusiveTransaction(async () => {
			await T$2(this, t, m$3).call(this, "BEGIN"), x$3(this, p$2, !0);
			let e = !1, r = () => {
				if (e) throw new Error("Transaction is closed");
			}, o = {
				query: async (i, c, u) => (r(), await T$2(this, t, x$2).call(this, i, c, u)),
				sql: async (i, ...c) => {
					r();
					let { query: u, params: n } = g(i, ...c);
					return await T$2(this, t, x$2).call(this, u, n);
				},
				exec: async (i, c) => (r(), await T$2(this, t, m$3).call(this, i, c)),
				rollback: async () => {
					r(), await T$2(this, t, m$3).call(this, "ROLLBACK"), e = !0;
				},
			...
			try {
				let i = await s(o);
				return e || (e = !0, await T$2(this, t, m$3).call(this, "COMMIT")), x$3(this, p$2, !1), i;
			} catch (i) {
				throw e || (e = !0, await T$2(this, t, m$3).call(this, "ROLLBACK")), x$3(this, p$2, !1), i;
			}
		});
	}
...
P$1 = /* @__PURE__ */ new WeakMap(), p$2 = /* @__PURE__ */ new WeakMap(), t = /* @__PURE__ */ new WeakSet(), y$2 = async function(s, e = {}) {
	return await this.execProtocolStream(s, {
		...e,
		syncToFs: !1
	});
}, x$2 = async function(s, e = [], r) {
	return await this._runExclusiveQuery(async () => {
		T$2(this, t, _).call(this, "runQuery", s, e, r), await this._handleBlob(r?.blob);
		let o = [];
		try {
			let c = await T$2(this, t, y$2).call(this, $e$1.parse({
				text: s,
				types: r?.paramTypes
			}), r), u = bn(await T$2(this, t, y$2).call(this, $e$1.describe({ type: "S" }), r)), n = e.map((b, k) => {
				let D = u[k];
			...
			o = [
				...c,
				...await T$2(this, t, y$2).call(this, $e$1.bind({ values: n }), r),
				...await T$2(this, t, y$2).call(this, $e$1.describe({ type: "P" }), r),
				...await T$2(this, t, y$2).call(this, $e$1.execute({}), r)
			];
		} catch (c) {
			...
			o.push(...await T$2(this, t, y$2).call(this, $e$1.sync(), r));
		}
		await this._cleanupBlob(), h$1(this, p$2) || await this.syncToFs();
		let i = await this._getWrittenBlob();
		return hn(o, this.parsers, r, i)[0];
	});
}, m$3 = async function(s, e) {
	return await this._runExclusiveQuery(async () => {
		T$2(this, t, _).call(this, "runExec", s, e), await this._handleBlob(e?.blob);
		let r = [];
		try {
			r = await T$2(this, t, y$2).call(this, $e$1.query(s), e);
		} catch (i) {
		...
		this._cleanupBlob(), h$1(this, p$2) || await this.syncToFs();
...
var s$1 = typeof processModule == "object" && typeof processModule.versions == "object" && typeof processModule.versions.node == "string" && !h();
var m$2 = "/pglite";
var y$1 = globalThis && typeof globalThis.process < "u" ? globalThis.process : { exitCode: void 0 };
var a = /* @__PURE__ */ new Map();
async function c(t) {
	s$1 || a.has(t.toString()) || a.set(t.toString(), fetch(t));
}
var o$1 = /* @__PURE__ */ new Map();
async function b$1(t, e, r) {
	if (r || o$1.has(e.toString())) {
		let i = r || o$1.get(e.toString());
		return {
	...
	if (s$1) {
		...
		return o$1.set(e.toString(), n), {
			instance: l,
			module: n
		};
	} else {
		a.has(e.toString()) || c(e);
...
async function w$1(t) {
	return s$1 ? (await (await import("node:fs/promises")).readFile(t)).buffer : (c(t), (await a.get(t.toString())).clone().arrayBuffer());
}
var S$1 = () => {
...
//#endregion
//#region node_modules/@electric-sql/pglite/dist/chunk-IFSHUC46.js
var Y = D$4((Xr, M) => {
	"use strict";
	u$1();
...
var ie$1 = D$4((Jr, P) => {
	"use strict";
	u$1();
	var ye = Y(), T = W$2(), tr = 512, oe = T.TPERMALL, Fe = 0, he = 0, ae = [
		[
			"name",
			100,
			0,
...
var Re$1 = D$4((nt, Oe) => {
	"use strict";
	u$1();
	var yr = Y(), Fr = W$2(), hr = Me$1(), wr = ke$1();
	yr.extend(Oe.exports, hr, wr, Fr);
});
u$1();
u$1();
var D$2 = L$3(Re$1(), 1);
async function ue$1(e, r, t = "pgdata", n = "auto") {
...
async function at$1(e, r, t) {
	...
	try {
		...
		if (l instanceof Error && l.message.includes("File is corrupted")) n = await De(n), s = (0, D$2.untar)(n);
		else throw l;
	}
	for (let l of s) {
		...
		l.type === D$2.REGTYPE ? (e.writeFile(u, l.data), e.utime(u, Ne(l.modifyTime), Ne(l.modifyTime))) : l.type === D$2.DIRTYPE && (e.analyzePath(u).exists || e.mkdir(u));
	}
}
function br(e, r) {
	let t = [], n = (o) => {
...
function Br(e, r, t) {
	t || (t = {});
	let n = t.escape || "\\", o = "(\\" + n + `['"` + He$1 + `]|[^\\s'"` + He$1 + "])+", s = Lr(e, new RegExp(["(" + Be$1 + ")", "(" + o + "|" + Nr + "|" + xr + ")+"].join("|"), "g"));
	...
	return s.map(function(u) {
		...
		for (_ = 0; _ < d.length; _++) {
			...
			else if (c) E === c ? c = !1 : c === Le ? f += E : E === n ? (_ += 1, E = d.charAt(_), E === Ce$1 || E === n || E === de$1 ? f += E : f += n + E) : E === de$1 ? f += g() : f += E;
			else if (E === Ce$1 || E === Le) c = E;
			else {
				if (Ue$1.test(E)) return { op: d };
				if (Ir.test(E)) {
					l = !0;
...
var wt$1 = I$2 + "/bin/postgres";
var ze = I$2 + "/pgstdout";
var je$1 = I$2 + "/pgstdin";
function G$1(e, ...r) {
...
async function Yr({ pg: e, debug: r, args: t, wasmModule: n }) {
	let o, a, s, l = !1, u = [], d = 0, c = -1, p = -1, f = "", m = "", _ = (S) => {
		let v = S.shift();
		G$1(r, "initdb: firstArg", v), zr(v === "/pglite/bin/postgres", `trying to execute ${v}`), e.Module.HEAPU8.set(g), G$1(r, "executing pg main with", S);
		let h = e.callMain(S);
		return G$1(r, h), u = [], h;
	}, g = e.Module.HEAPU8.slice(), y = await Ie$1({
		arguments: t,
		noExitRuntime: !1,
		thisProgram: Gr,
		stdin: () => null,
		print: (S) => {
			m += S, G$1(r, "initdbout", S);
		},
		printErr: (S) => {
			f += S, G$1(r, "initdberr", S);
		},
		instantiateWasm: (S, v) => {
			let h = new URL("./initdb.wasm", import.meta.url);
			return p$1.instantiateWasm(S, h, n).then(({ instance: b, module: F }) => {
				v(b, F);
			}), {};
		},
		preRun: [
			...
			(S) => {
				S.onRuntimeInitialized = () => {
					o = S.addFunction((v) => (u = Ge(S.UTF8ToString(v)), _(u)), "pi"), S._pgl_set_system_fn(o), a = S.addFunction((v, h) => {
						let b = S.UTF8ToString(h);
						if (u = Ge(S.UTF8ToString(v)), b === "r") return d = _(u), c;
						if (b === "w") return l = !0, p;
					...
					{
						let v = e.Module.stringToUTF8OnStack(je$1), h = e.Module.stringToUTF8OnStack("r");
					...
					}
					{
						...
						c = S._fopen(v, h);
						let b = S.stringToUTF8OnStack(je$1), F = S.stringToUTF8OnStack("w");
						p = S._fopen(b, F);
					}
				};
			},
	...
	return G$1(r, "calling initdb.main with", t), {
...
async function At({ pg: e, debug: r, args: t, wasmModule: n }) {
	return await Yr({
		pg: e,
		debug: r,
		args: [
...
var Ye$1 = class {
	...
	async closeFs() {}
	async dumpTar(r, t) {
		return ue$1(this.pg.Module.FS, B$1, r, t);
	}
};
var We$1 = class {
	...
	let t = e.FS, n = r.debug ? console.log : null, o = {
		tryFSOperation(a) {
			try {
				...
				throw s.code ? s.code === "UNKNOWN" ? new t.ErrnoError(Ve$1.EINVAL) : new t.ErrnoError(s.code) : s;
			}
		},
		mount(a) {
		...
		stream_ops: {
			...
			mmap(a, s, l, u, d) {
				if (n?.("mmap stream", o.realPath(a.node), s, l, u, d), !t.isFile(a.node.mode)) throw new t.ErrnoError(Ve$1.ENODEV);
				let c = e.mmapAlloc(s);
	...
	return async function(moduleArg = {}) {
			...
			function a(o) {
				...
				function p(c, w, S, F) {
					...
					Module.dataFileDownloads ?? (Module.dataFileDownloads = {}), fetch(c).catch((E) => Promise.reject(new Error(`Network Error: ${c}`, { cause: E }))).then((E) => {
						...
						let y = E.body.getReader(), M = () => y.read().then(te).catch((j) => Promise.reject(new Error(`Unexpected error while handling : ${E.url} ${j}`, { cause: j }))), b = [], k = E.headers, A = Number(k.get("Content-Length") ?? w), V = 0, te = ({ done: j, value: X }) => {
							if (j) {
								let R = new Uint8Array(b.map((q) => q.length).reduce((q, nt) => q + nt, 0)), G = 0;
								for (let q of b) R.set(q, G), G += q.length;
								S(R.buffer);
							} else {
								...
								let R = 0, G = 0;
								for (let q of Object.values(Module.dataFileDownloads)) R += q.loaded, G += q.total;
								return Module.setStatus?.(`Downloading data... (${R}/${G})`), M();
							}
						};
				...
				function f(c) {
					...
					function S(M, b, k) {
						this.start = M, this.end = b, this.audio = k;
					}
					S.prototype = {
						requests: {},
						open: function(M, b) {
					...
					for (var F = o.files, E = 0; E < F.length; ++E) new S(F[E].start, F[E].end, F[E].audio || 0).open("GET", F[E].filename);
					function y(M) {
						...
						for (var k = o.files, A = 0; A < k.length; ++A) S.prototype.requests[k[A].filename].onload();
		...
		var GOT = {}, currentModuleWeakSymbols = /* @__PURE__ */ new Set([]), GOTHandler = { get(e, t) {
			...
			function o() {
				for (var R = 0, G = 1;;) {
					var q = e[t++];
					if (R += (q & 127) * G, G *= 128, !(q & 128)) break;
				}
				return R;
			}
			function _() {
			...
			if (n == "dylink") {
				...
				s(n !== "dylink.0");
				for (var w = 1, S = 2, F = 3, E = 4, y = 256, M = 3, b = 1; t < r;) {
					var k = a(), A = o();
					if (k === w) g.memorySize = o(), g.memoryAlign = o(), g.tableSize = o(), g.tableAlign = o();
					else if (k === S) for (var u = o(), f = 0; f < u; ++f) c = _(), g.neededDynlibs.push(c);
					else if (k === F) for (var V = o(); V--;) {
						var te = _(), j = o();
						j & y && g.tlsExports.add(te);
					}
					else if (k === E) for (var V = o(); V--;) {
						var X = _(), te = _(), j = o();
...
`));
			...
			createLazyFile(e, t, r, a, o) {
				class _ {
					...
					cacheLength() {
						...
						var f = Number(u.getResponseHeader("Content-length")), c, w = (c = u.getResponseHeader("Accept-Ranges")) && c === "bytes", S = (c = u.getResponseHeader("Content-Encoding")) && c === "gzip", F = 1048576;
						w || (F = f);
						var E = (M, b) => {
							...
							if (k.open("GET", r, !1), f !== F && k.setRequestHeader("Range", "bytes=" + M + "-" + b), k.responseType = "arraybuffer", k.overrideMimeType && k.overrideMimeType("text/plain; charset=x-user-defined"), k.send(null), !(k.status >= 200 && k.status < 300 || k.status === 304)) throw new Error("Couldn't load " + r + ". Status: " + k.status);
							return k.response !== void 0 ? new Uint8Array(k.response || []) : intArrayFromString(k.responseText || "", !0);
						}, y = this;
						y.setDataGetter((M) => {
							var b = M * F, k = (M + 1) * F - 1;
							if (k = Math.min(k, f - 1), typeof y.chunks[M] > "u" && (y.chunks[M] = E(b, k)), typeof y.chunks[M] > "u") throw new Error("doXHR failed!");
							return y.chunks[M];
						}), (S || !f) && (F = f = 1, f = this.getter(0).length, F = f, out("LazyFiles on gzip forces download of the whole file when length is accessed")), this._length = f, this._chunkSize = F, this.lengthKnown = !0;
					}
					get length() {
						return this.lengthKnown || this.cacheLength(), this._length;
					}
				...
				function m(g, u, f, c, w) {
					...
					var F = Math.min(S.length - w, c);
					if (S.slice) for (var E = 0; E < F; E++) u[f + E] = S[w + E];
					else for (var E = 0; E < F; E++) u[f + E] = S.get(w + E);
					return F;
				}
			...
			try {
				for (var _ = 0, s = t ? HEAP32[t >> 2] : 0, n = t ? HEAP32[t + 4 >> 2] : 0, l = r ? HEAP32[r >> 2] : 0, d = r ? HEAP32[r + 4 >> 2] : 0, p = a ? HEAP32[a >> 2] : 0, m = a ? HEAP32[a + 4 >> 2] : 0, g = 0, u = 0, f = 0, c = 0, w = 0, S = 0, F = (t ? HEAP32[t >> 2] : 0) | (r ? HEAP32[r >> 2] : 0) | (a ? HEAP32[a >> 2] : 0), E = (t ? HEAP32[t + 4 >> 2] : 0) | (r ? HEAP32[r + 4 >> 2] : 0) | (a ? HEAP32[a + 4 >> 2] : 0), y = (X, R, G, q) => X < 32 ? R & q : G & q, M = 0; M < e; M++) {
					var b = 1 << M % 32;
					if (y(M, F, E, b)) {
						var k = SYSCALLS.getStreamFromFD(M), A = SYSCALLS.DEFAULT_POLLMASK;
						if (k.stream_ops.poll) {
							var V = -1;
							if (o) V = ((t ? HEAP32[o >> 2] : 0) + (t ? HEAP32[o + 4 >> 2] : 0) / 1e6) * 1e3;
							A = k.stream_ops.poll(k, V);
						}
...
${n}`), 0;
		...
		var _getaddrinfo = (e, t, r, a) => {
			...
			function m(g, u, f, c, w, S) {
				var F, E, y, M;
				return E = g === 10 ? 28 : 16, w = g === 10 ? inetNtop6(w) : inetNtop4(w), F = _malloc(E), M = writeSockaddr(F, g, w, S), assert(!M), y = _malloc(32), HEAP32[y + 4 >> 2] = g, HEAP32[y + 8 >> 2] = u, HEAP32[y + 12 >> 2] = f, HEAPU32[y + 24 >> 2] = c, HEAPU32[y + 20 >> 2] = F, g === 10 ? HEAP32[y + 16 >> 2] = 28 : HEAP32[y + 16 >> 2] = 16, HEAP32[y + 28 >> 2] = 0, y;
			}
...
var N = class N extends z$1 {
	constructor(r = {}, a = {}) {
		...
		R$1(this, $$1, []);
		R$1(this, W$1, 0);
		R$1(this, z, /* @__PURE__ */ new Uint8Array(0));
		R$1(this, L$1, 0);
		R$1(this, he, -1);
		R$1(this, xe, -1);
		R$1(this, we, -1);
		...
		typeof r == "string" ? a = {
			...
			...this.serializers,
			...a.serializers
		}), a?.debug !== void 0 && (this.debug = a.debug), a?.relaxedDurability !== void 0 && x$3(this, ie, a.relaxedDurability), x$3(this, ue, a.extensions ?? {}), this.waitReady = T$2(this, x$1, Ye).call(this, a ?? {});
	}
	get ENV() {
		return this.mod?.ENV;
	}
	...
	async close() {
		...
		try {
			...
			let o = a;
			o.name === "ExitStatus" && o.status === 0 || T$2(this, x$1, B).call(this, "An error occured while closing the db", a.toString());
		} finally {
		...
		let r = p$1.pgliteProc.exitCode;
		try {
			this.mod._emscripten_force_exit(0), this.mod = void 0;
		} catch (a) {
			T$2(this, x$1, B).call(this, a), a.status !== 0 && T$2(this, x$1, B).call(this, "Error when exiting", a.toString());
		} finally {
			try {
				p$1.pgliteProc.exitCode = r;
			} catch {}
		}
	}
	...
	execProtocolRawSync(r) {
		let a = this.mod;
		if (x$3(this, W$1, 0), x$3(this, L$1, 0), x$3(this, $$1, r), h$1(this, H$1) || x$3(this, H$1, T$2(this, x$1, et)), h$1(this, z).length !== N.DEFAULT_RECV_BUF_SIZE && x$3(this, z, new Uint8Array(N.DEFAULT_RECV_BUF_SIZE)), r[0] === 88) return /* @__PURE__ */ new Uint8Array(0);
		if (r[0] === 0) return T$2(this, x$1, st).call(this, r);
		try {
			for (; h$1(this, W$1) < r.length || a._pq_buffer_remaining_data() > 0;) try {
		...
		return x$3(this, $$1, []), h$1(this, L$1) ? new Uint8Array(h$1(this, z).subarray(0, h$1(this, L$1))) : /* @__PURE__ */ new Uint8Array(0);
	}
	...
	async execProtocolRawStream(r, { syncToFs: a = !0, onRawData: o }) {
		x$3(this, H$1, (_) => (o(_), _.length)), this.execProtocolRawSync(r), a && await this.syncToFs();
	}
	async execProtocol(r, { syncToFs: a = !0, throwOnError: o = !0, onNotice: _ } = {}) {
		...
		let s = await this.execProtocolRaw(r, { syncToFs: a }), n = h$1(this, I$1).databaseError, l = {
			messages: h$1(this, I$1).results,
			data: s
		};
		if (x$3(this, I$1, new ae()), x$3(this, H$1, void 0), o && n) throw x$3(this, pe, new pe$1()), n;
		return l;
	}
	async execProtocolStream(r, { syncToFs: a, throwOnError: o = !0, onNotice: _ } = {}) {
		x$3(this, I$1, new ae({
			throwOnError: o,
			onNotice: _
		})), x$3(this, H$1, T$2(this, x$1, qe)), await this.execProtocolRaw(r, { syncToFs: a });
		let s = h$1(this, I$1).databaseError, n = h$1(this, I$1).results;
		if (x$3(this, I$1, new ae()), x$3(this, H$1, void 0), o && s) throw x$3(this, pe, new pe$1()), s;
		return n;
	}
	isInTransaction() {
	...
	async listen(r, a, o) {
		return this._runExclusiveListen(() => T$2(this, x$1, rt).call(this, r, a, o));
	}
	async unlisten(r, a, o) {
		return this._runExclusiveListen(() => T$2(this, x$1, at).call(this, r, a, o));
	}
	onNotification(r) {
...
H$1 = /* @__PURE__ */ new WeakMap(), oe = /* @__PURE__ */ new WeakMap(), _e = /* @__PURE__ */ new WeakMap(), se = /* @__PURE__ */ new WeakMap(), ie = /* @__PURE__ */ new WeakMap(), ke = /* @__PURE__ */ new WeakMap(), Te = /* @__PURE__ */ new WeakMap(), Pe = /* @__PURE__ */ new WeakMap(), Ce = /* @__PURE__ */ new WeakMap(), de = /* @__PURE__ */ new WeakMap(), ue = /* @__PURE__ */ new WeakMap(), Me = /* @__PURE__ */ new WeakMap(), pe = /* @__PURE__ */ new WeakMap(), ne = /* @__PURE__ */ new WeakMap(), ee = /* @__PURE__ */ new WeakMap(), D$1 = /* @__PURE__ */ new WeakMap(), le = /* @__PURE__ */ new WeakMap(), ce = /* @__PURE__ */ new WeakMap(), I$1 = /* @__PURE__ */ new WeakMap(), me = /* @__PURE__ */ new WeakMap(), $$1 = /* @__PURE__ */ new WeakMap(), W$1 = /* @__PURE__ */ new WeakMap(), z = /* @__PURE__ */ new WeakMap(), L$1 = /* @__PURE__ */ new WeakMap(), he = /* @__PURE__ */ new WeakMap(), xe = /* @__PURE__ */ new WeakMap(), we = /* @__PURE__ */ new WeakMap(), ge = /* @__PURE__ */ new WeakMap(), x$1 = /* @__PURE__ */ new WeakSet(), Xe = function(r) {
	...
	r.pgliteWasmModule || p$1.startArtifactDownload(new URL("./pglite.wasm", import.meta.url)), r.initdbWasmModule || p$1.startArtifactDownload(new URL("./initdb.wasm", import.meta.url));
	let s = new URL("./pglite.data", import.meta.url), n = r.fsBundle ? r.fsBundle.arrayBuffer() : p$1.getFsBundle(s), l;
	n.then((u) => {
		l = u;
	});
	let d = new WebAssembly.Memory({
		...
		stdin: () => null,
		print: (u) => {
			T$2(this, x$1, Xe).call(this, u);
		},
		printErr: (u) => {
			T$2(this, x$1, Ke).call(this, u);
		},
		instantiateWasm: (u, f) => {
		...
		preRun: [
			...
			(u) => {
				...
				u.FS.registerDevice(f, {
					...
					read: (w, S, F, E, y) => {
						...
						let k = Math.min(b.length - y, E);
						for (let A = 0; A < k; A++) S[F + A] = b[y + A];
						return k;
					},
					write: (w, S, F, E, y) => (h$1(this, ee) ?? x$3(this, ee, []), h$1(this, ee).push(S.slice(F, F + E)), E),
					llseek: (w, S, F) => {
						let E = h$1(this, ne);
						if (!E) throw new Error("No /dev/blob File or Blob provided to llseek");
						let y = S;
						if (F === 1 ? y += w.position : F === 2 && (y = new Uint8Array(E).length), y < 0) throw new u.FS.ErrnoError(28);
						return y;
					}
			...
			(u) => {
				u.FS.chmod("/home/postgres/.pgpass", 384), u.FS.chmod(Gr, 365), u.FS.chmod(wt$1, 365);
			}
		]
	...
	if (p.pg_extensions = a, await n, this.mod = await We(p), await this.fs.initialSyncFs(), r.icuDataDir && await T$2(this, x$1, $e).call(this, r.icuDataDir), !r.noInitDb) {
		if (r.loadDataDir) {
			...
			T$2(this, x$1, B).call(this, "pglite: loading data from tarball"), await at$1(this.mod.FS, r.loadDataDir, B$1);
		} else if (this.mod.FS.analyzePath("/pglite/data/PG_VERSION").exists) T$2(this, x$1, B).call(this, "pglite: found DB, resuming");
		else {
			T$2(this, x$1, B).call(this, "pglite: no db in filesystem, running initdb");
			let u = { ...r };
			u.noInitDb = !0, u.dataDir = void 0, u.extensions = void 0, u.loadDataDir = void 0, u.fs = void 0;
			let f = await N.create(u), c = await At({
				pg: f,
				debug: r.debug,
			...
			f.close(), await at$1(this.mod.FS, w, B$1), await this.syncToFs();
		}
		await Ue(this.mod, (...u) => T$2(this, x$1, B).call(this, ...u)), T$2(this, x$1, Qe).call(this, g, r), this.mod._pgl_setPGliteActive(1), T$2(this, x$1, _t).call(this, {
			pgDataFolder: B$1,
			startParams: [...r.startParams || N.defaultStartParams, ...this.debug ? ["-d", this.debug.toString()] : []]
		}), T$2(this, x$1, ot).call(this), x$3(this, oe, !0), r.username && await this.exec(`SET ROLE ${r.username};`), await this._initArrayTypes();
...
shared_preload_libraries=${r.join(",")}`;
	...
	T$2(this, x$1, B).call(this, `pglite: icuDataDir specified, removing default icu data dir at ${jr}`), p$1.rmdirRecursive(this.mod.FS, jr), T$2(this, x$1, B).call(this, `pglite: loading icu data from tarball ${r}`), this.mod.FS.mkdirTree(jr), await at$1(this.mod.FS, r, jr);
}, Je = function(r) {
	x$3(this, he, r.addFunction((a) => (T$2(this, x$1, B).call(this, `Postgres tried to execute ${r.UTF8ToString(a)}, returning 1.`), 1), "pi")), r._pgl_set_system_fn(h$1(this, he)), x$3(this, xe, r.addFunction((a, o) => {
		...
		T$2(this, x$1, B).call(this, "pclose_fn", a);
		...
		return h$1(this, H$1).call(this, _);
	}, "iii")), x$3(this, me, r.addFunction((a, o) => {
		let _ = h$1(this, $$1).length - h$1(this, W$1);
		return _ > o && (_ = o), this.mod.HEAP8.set(h$1(this, $$1).subarray(h$1(this, W$1), h$1(this, W$1) + _), a), x$3(this, W$1, h$1(this, W$1) + _), _;
	}, "iii")), r._pgl_set_rw_cbs(h$1(this, me), h$1(this, ce));
}, et = function(r) {
	let a = r.slice(), o = h$1(this, L$1) + a.length;
	if (o > h$1(this, z).length) {
		let _ = h$1(this, z).length + (h$1(this, z).length >> 1) + o;
		o > N.MAX_BUFFER_SIZE && (o = N.MAX_BUFFER_SIZE);
		let s = new Uint8Array(_);
		s.set(h$1(this, z).subarray(0, h$1(this, L$1))), x$3(this, z, s);
	}
	return h$1(this, z).set(a, h$1(this, L$1)), x$3(this, L$1, h$1(this, L$1) + a.length), T$2(this, x$1, qe).call(this, a);
}, qe = function(r) {
	return h$1(this, pe).parse(r, (a) => {
		let o = T$2(this, x$1, tt).call(this, a);
		o && h$1(this, I$1).results.push(o);
	}), r.length;
}, tt = function(r) {
	if (!h$1(this, I$1).databaseError) {
		if (r instanceof N$1) h$1(this, I$1).throwOnError && (h$1(this, I$1).databaseError = r);
		else if (r instanceof ee$1) this.debug > 0 && console.warn(r), h$1(this, I$1).onNotice && h$1(this, I$1).onNotice(r);
		else if (r instanceof J$1) {
			let a = h$1(this, D$1).get(r.channel);
			a && a.forEach((o) => {
	...
	h$1(this, D$1).has(_) || h$1(this, D$1).set(_, /* @__PURE__ */ new Set()), h$1(this, D$1).get(_).add(a);
	try {
		await s.exec(`LISTEN ${r}`);
	} catch (n) {
		throw h$1(this, D$1).get(_).delete(a), h$1(this, D$1).get(_)?.size === 0 && h$1(this, D$1).delete(_), n;
	}
	return async (n) => {
	...
	let _ = p$1.toPostgresName(r), s = o ?? this, n = async () => {
		await s.exec(`UNLISTEN ${r}`), h$1(this, D$1).get(_)?.size === 0 && h$1(this, D$1).delete(_);
	};
	a ? (h$1(this, D$1).get(_)?.delete(a), h$1(this, D$1).get(_)?.size === 0 && await n()) : await n();
}, ot = function() {
	...
	x$3(this, W$1, 0), x$3(this, L$1, 0), x$3(this, $$1, r);
	...
	return this.mod._pgl_sendConnData(), this.mod._pgl_pq_flush(), x$3(this, $$1, []), h$1(this, L$1) ? h$1(this, z).subarray(0, h$1(this, L$1)) : /* @__PURE__ */ new Uint8Array(0);
}, N.paths = {
	PG_ROOT: I$2,
	PGDATA: B$1,
	ICU_DATA_PATH: jr,
	INITDB_EXE_PATH: Gr,
	POSTGRES_EXE_PATH: wt$1
...
var nodefs_exports = /* @__PURE__ */ __exportAll({ NodeFS: () => m$1 });
u$1();
var m$1 = class extends Ye$1 {
	constructor(t) {
...
var opfs_ahp_exports = /* @__PURE__ */ __exportAll({ OpfsAhpFS: () => L });
u$1();
var $ = "state.txt";
var G = "data";
var T = {
...
var L = class extends We$1 {
	...
	async maintainPool(e) {
		...
		for (let i = 0; i < t; i++) o.push(new Promise(async (c) => {
			++this.poolCounter;
			let a = `${(Date.now() - 1704063600).toString(16).padStart(8, "0")}-${this.poolCounter.toString(16).padStart(8, "0")}`, h = await h$1(this, F).getFileHandle(a, { create: !0 }), d = await h.createSyncAccessHandle();
			h$1(this, b).set(a, h), h$1(this, m).set(a, d), T$2(this, n, k).call(this, {
				opp: "createPoolFile",
				args: [a]
		...
		for (let i = 0; i > t; i--) o.push(new Promise(async (c) => {
			...
			T$2(this, n, k).call(this, {
				opp: "deletePoolFile",
				args: [a]
			});
			let h = h$1(this, b).get(a);
			h$1(this, m).get(a)?.close(), await h$1(this, F).removeEntry(h.name), h$1(this, b).delete(a), h$1(this, m).delete(a), c();
		}));
		await Promise.all(o);
	}
	...
	_chmodState(e, t) {
		let o = T$2(this, n, f).call(this, e);
		o.mode = t;
	}
	close(e) {
	...
	lstat(e) {
		let t = T$2(this, n, f).call(this, e), o = t.type === "file" ? h$1(this, m).get(t.backingFilename).getSize() : 0, i = 4096;
		return {
			dev: 0,
			ino: 0,
			mode: t.mode,
	...
	_mkdirState(e, t) {
		let o = T$2(this, n, w).call(this, e), i = o.pop(), c = [], a = this.state.root;
		for (let d of o) {
	...
	open(e, t, o) {
		...
		let c = T$2(this, n, W).call(this);
		return h$1(this, P).set(c, e), h$1(this, D).set(e, c), c;
	}
	readdir(e) {
		let t = T$2(this, n, f).call(this, e);
		if (t.type !== "directory") throw new p("ENOTDIR", "Not a directory");
		return Object.keys(t.children);
	}
	read(e, t, o, i, c) {
		let a = T$2(this, n, I).call(this, e), h = T$2(this, n, f).call(this, a);
		if (h.type !== "file") throw new p("EISDIR", "Is a directory");
		return h$1(this, m).get(h.backingFilename).read(new Uint8Array(t.buffer, o, i), { at: c });
	}
	rename(e, t) {
		T$2(this, n, O).call(this, {
			opp: "rename",
	...
	_renameState(e, t, o = !1) {
		let i = T$2(this, n, w).call(this, e), c = i.pop(), a = T$2(this, n, f).call(this, i.join("/"));
		if (!Object.prototype.hasOwnProperty.call(a.children, c)) throw new p("ENOENT", "No such file or directory");
		let h = T$2(this, n, w).call(this, t), d = h.pop(), l = T$2(this, n, f).call(this, h.join("/"));
	...
	_rmdirState(e) {
		let t = T$2(this, n, w).call(this, e), o = t.pop(), i = T$2(this, n, f).call(this, t.join("/"));
	...
	_unlinkState(e, t = !1) {
		let o = T$2(this, n, w).call(this, e), i = o.pop(), c = T$2(this, n, f).call(this, o.join("/"));
		...
		if (delete c.children[i], t) {
			let h = h$1(this, m).get(a.backingFilename);
			h?.truncate(0), h$1(this, S).add(h), h$1(this, D).has(e) && (h$1(this, P).delete(h$1(this, D).get(e)), h$1(this, D).delete(e));
		}
	...
	_utimesState(e, t, o) {
		let i = T$2(this, n, f).call(this, e);
		i.lastModified = o;
	}
	writeFile(e, t, o) {
		let i = T$2(this, n, w).call(this, e), c = i.pop(), a = T$2(this, n, f).call(this, i.join("/"));
		if (Object.prototype.hasOwnProperty.call(a.children, c)) {
			let l = a.children[c];
			l.lastModified = Date.now(), T$2(this, n, k).call(this, {
				opp: "setLastModified",
			...
			a.children[c] = l, T$2(this, n, k).call(this, {
				opp: "createFileNode",
				args: [e, l]
			});
		}
		let h = a.children[c], d = h$1(this, m).get(h.backingFilename);
	...
	write(e, t, o, i, c) {
		let a = T$2(this, n, I).call(this, e), h = T$2(this, n, f).call(this, a);
		if (h.type !== "file") throw new p("EISDIR", "Is a directory");
		let d = h$1(this, m).get(h.backingFilename);
...
H = /* @__PURE__ */ new WeakMap(), v = /* @__PURE__ */ new WeakMap(), F = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap(), y = /* @__PURE__ */ new WeakMap(), b = /* @__PURE__ */ new WeakMap(), m = /* @__PURE__ */ new WeakMap(), x = /* @__PURE__ */ new WeakMap(), P = /* @__PURE__ */ new WeakMap(), D = /* @__PURE__ */ new WeakMap(), S = /* @__PURE__ */ new WeakMap(), n = /* @__PURE__ */ new WeakSet(), C = async function() {
	x$3(this, H, await navigator.storage.getDirectory()), x$3(this, v, await T$2(this, n, j).call(this, this.dataDir, { create: !0 })), x$3(this, F, await T$2(this, n, j).call(this, G, {
		from: h$1(this, v),
		create: !0
	})), x$3(this, M, await h$1(this, v).getFileHandle($, { create: !0 })), x$3(this, y, await h$1(this, M).createSyncAccessHandle());
...
`), i = !1;
	...
	let o = T$2(this, n, k).call(this, e);
	try {
		t();
	} catch (i) {
...
${t}`), i = h$1(this, y).getSize();
	...
	let o = T$2(this, n, w).call(this, e), i = t || this.state.root;
	for (let c of o) {
	...
	let o = T$2(this, n, w).call(this, e), i = t?.from || h$1(this, H);
	for (let c of o) i = await i.getDirectoryHandle(c, { create: t?.create });
	return i;
};
var p = class extends Error {
	constructor(A, e) {
		super(e), typeof A == "number" ? this.code = A : typeof A == "string" && (this.code = Ve$1[A]);
	}
};
//#endregion
export { performance_default as n, Ve as t };
