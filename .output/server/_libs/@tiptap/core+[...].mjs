...
var isDev = typeof processModule !== "undefined" && false;
...
function render(tag, attributes, hasMultipleChildren) {
	...
	if (hasMultipleChildren && Array.isArray(children)) return [
		tag,
		rest,
		...children
	];
...
//#endregion
export { parseIndentedBlocks as A, Selection as B, isNodeActive as C, markPasteRule as D, markInputRule as E, Decoration as F, Slice as G, Mapping as H, DecorationSet as I, NodeSelection as L, textblockTypeInputRule as M, wrappingInputRule as N, mergeAttributes as O, keydownHandler as P, Plugin as R, isAtStartOfNode as S, isNodeSelection as T, dropPoint as U, TextSelection as V, Fragment as W, getNodeType as _, Mark as a, getStyleProperty as b, callOrReturn as c, findChildrenInRange as d, getAttributes as f, getNodeAtPosition as g, getMarksBetween as h, InputRule as i, renderNestedMarkdownContent as j, nodeInputRule as k, canInsertNode as l, getExtensionField as m, Editor as n, Node3 as o, getChangedRanges as p, Extension as r, PasteRule as s, h as t, combineTransactionSteps as u, getPreviousBlockSibling as v, isNodeEmpty as w, isAtEndOfNode as x, getRenderedAttributes as y, PluginKey as z };
